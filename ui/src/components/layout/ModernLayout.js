...
const navigationItems = [
  { id: 'dispatch', label: 'Dispatch Board', icon: MapPin, path: '/dispatch' },
...
export function ModernLayout({ children, currentPath, onNavigate }) {
      ...
      <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 lg:block hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-2 p-6 border-b border-gray-200">
            ...
            <span className="text-xl font-semibold text-gray-900">TMS Control</span>
          </div>
